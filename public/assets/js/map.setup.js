...
function showMap()
{
  //  console.log(location1.lat());
    ...
    // custom marker
    var rabbit = new google.maps.MarkerImage('img/gmap-icon2.png');
    var rabbit2 = new google.maps.MarkerImage('img/mapIcons/marker_red.png');
...
function continueShowRoute(location1, location2)
{
 ...
 infowindow2.setContent("<img src='img/logo.png'  width='150'/>");
//  infowindow1.setContent(text2);
}
